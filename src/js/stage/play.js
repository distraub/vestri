...
class PlayScreen extends Stage {
  onResetEvent () {
    ...
    const livesText = new BitmapText(20, game.viewport.height - (ultraTall ? 80 : 20), {
        font: 'PressStart2P',
        size: ultraTall ? 1.5 :0.8,
        textBaseline: 'bottom',
        textAlign: 'left',
    ...
    const shieldText = new BitmapText(game.viewport.width - 20, game.viewport.height - (ultraTall ? 80 : 20), {
        font: 'PressStart2P',
        size: ultraTall ? 1.5 :0.8,
        textBaseline: 'bottom',
        textAlign: 'right',
